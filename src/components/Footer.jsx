...
const Footer = () => {
  return (
    <div className="max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300">
      <div className="">
        <h1 className="w-full text-3xl font-bold text-[#00df9a]">DAFI.</h1>
        <p className="py-4">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos iure
          molestiae hic, quisquam deleniti tempore magni unde recusandae labor.
        </p>
        <div className="flex justify-between md:w-[75%] my-6">
          ...
          <FaDribbbleSquare size={30} className="" />
        </div>
      </div>
